...
const translations: Translations = {
  zh: {
    ...
    'auth.sendMagicLink': '使用邮箱登录',
    'auth.sendingMagicLink': '发送中...',
    'auth.magicLinkSent': '邮件已发送',
    'auth.magicLinkSentDesc': '请检查您的邮箱，点击链接完成登录',
    'auth.checkEmail': '检查邮箱',
    'auth.resendLink': '重新发送',
  ...
  en: {
    ...
    'auth.sendMagicLink': 'Sign in with Email',
    'auth.sendingMagicLink': 'Sending...',
    'auth.magicLinkSent': 'Email Sent',
    'auth.magicLinkSentDesc': 'Please check your email and click the link to complete sign in',
